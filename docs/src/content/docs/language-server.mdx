...
- **Diagnostics**
  ...
  - Static type checking — HM-style inference with nominal/structural types, function types, nullable unions, and numeric constraints, via [`#:` typing comments](/type-checker) *(🧪 experimental)*
