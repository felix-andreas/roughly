...
- **Phase 2 IDE — in progress.** `IdeDatabase` trait + `EngineIde` view; the existing `crates/analysis/tests/ide/` `MultiFile` suite (cross-file cases included) is the differential corpus.
