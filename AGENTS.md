...
- **`docs/` (the docs site)** — the authoritative, user- and contributor-facing specs. They are contracts; keeping them accurate is mandatory.
  ...
  - Contributing: `contributing/{architecture,structure,testing,authoring-stubs}.md`.
